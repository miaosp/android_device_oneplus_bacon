...
PRODUCT_COPY_FILES += \
    ...
    device/oneplus/bacon/configs/init.bacon.usb.rc:root/init.bacon.usb.rc \
    device/oneplus/bacon/configs/ueventd.qcom.rc:root/ueventd.qcom.rc \
    device/oneplus/bacon/configs/fstab.bacon:root/fstab.qcom \
    device/oneplus/bacon/configs/twrp.fstab:recovery/root/etc/twrp.fstab
...
PRODUCT_COPY_FILES += \
    device/oneplus/bacon/configs/sec_config:system/etc/sec_config
...
# Wifi config
PRODUCT_COPY_FILES += \
    device/oneplus/bacon/configs/p2p_supplicant_overlay.conf:system/etc/wifi/p2p_supplicant_overlay.conf \
    device/oneplus/bacon/configs/wpa_supplicant_overlay.conf:system/etc/wifi/wpa_supplicant_overlay.conf
...
PRODUCT_COPY_FILES += \
    device/oneplus/bacon/configs/init.bacon.bt.sh:system/etc/init.bacon.bt.sh
...
# GPS configuration
PRODUCT_COPY_FILES += \
    device/oneplus/bacon/gps/gps.conf:system/etc/gps.conf \
    device/oneplus/bacon/gps/izat.conf:system/etc/izat.conf
